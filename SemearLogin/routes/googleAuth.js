...
function getDefaultAfterLoginUrl() {
    return String(process.env.DEFAULT_AFTER_LOGIN_URL || 'https://ejc.semearparoquial.com.br/dashboard').trim();
}
...
function configureGoogleStrategy() {
    ...
    passport.use(new GoogleStrategy(
        ...
        async (_accessToken, _refreshToken, profile, done) => done(null, profile)
    ));
